...
import pt.up.fe.alpha.seabiotablet.activities.MainActivity;
import pt.up.fe.alpha.seabiotablet.adapters.HomeTipsAdapter;
import pt.up.fe.alpha.seabiotablet.models.HomeTip;
...
public class HomeFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        tip.setBody("In some cases, researchers are already describing their data in a systematic approach, even without noticing it. They often resort to paper-based" +
                "laboratory notebooks to do so which, as you can understand, can be a frail support for such an important asset. SeaBioTablet is designed to quickly gather " +
                ...
                " Text-based notes can be a good starting point, but SeaBioTablet can use the integrated sensors to automatically record the available information.");
        tip.setResourceID("labtablet");
        items.add(tip);

        tip = new HomeTip();
        tip.setTitle("Taking advantage of built-in sensors");
        tip.setBody("<p>SeaBioTablet can read the device's built-in sensors, provided you find them useful." +
                ...
                "With this in mind, SeaBioTablet lets you record from these sources:</p>" +
                "   &#8226; Voice<br/>" +
                "   &#8226; Video<br/>" +
