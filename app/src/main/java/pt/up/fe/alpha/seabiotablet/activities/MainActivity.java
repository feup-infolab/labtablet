...
import pt.up.fe.alpha.seabiotablet.async.AsyncFavoriteSetup;
import pt.up.fe.alpha.seabiotablet.async.AsyncTaskHandler;
import pt.up.fe.alpha.seabiotablet.db_handlers.FavoriteMgr;
import pt.up.fe.alpha.seabiotablet.fragments.ConfigurationFragment;
import pt.up.fe.alpha.seabiotablet.fragments.DrawerFragment;
import pt.up.fe.alpha.seabiotablet.fragments.HomeFragment;
import pt.up.fe.alpha.seabiotablet.fragments.ListChangelogFragment;
import pt.up.fe.alpha.seabiotablet.fragments.ListFavoritesFragment;
import pt.up.fe.alpha.seabiotablet.fragments.ListFormFragment;
