...
import pt.up.fe.alpha.seabiotablet.fragments.SubmissionStep1;
import pt.up.fe.alpha.seabiotablet.fragments.SubmissionStep2;
import pt.up.fe.alpha.seabiotablet.fragments.SubmissionStep3;
import pt.up.fe.alpha.seabiotablet.fragments.SubmissionStep4;
            ...
            public void onPageScrolled(int position, float positionOffset, int positionOffsetPixels) {
                ...
                switch (position) {
                    case 0:
                        ...
                        break;
                    case 1:
                        //pb_submission_state.setProgress(33, true);
                        break;
                    case 2:
                        //pb_submission_state.setProgress(66, true);
                        break;
                    case 3:
                        //pb_submission_state.setProgress(100, true);
                        break;
                    default:
                        //pb_submission_state.setProgress(0, true);
                        break;
