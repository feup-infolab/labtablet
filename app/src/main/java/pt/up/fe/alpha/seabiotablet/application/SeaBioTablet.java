package pt.up.fe.alpha.seabiotablet.application;
...
public class SeaBioTablet extends Application {

    private static Context mContext;
    private RequestQueue mRequestQueue;
    private static SeaBioTablet mInstance;
    public static final String TAG = "SeaBioTablet";
    ...
    public static synchronized SeaBioTablet getInstance() {
        return mInstance;
    }
